...
export default function Sidebar() {
  ...
  return (
    <motion.aside
      className="hidden md:block fixed left-0 top-0 h-screen bg-gradient-to-b from-white via-white/98 to-pink-50/80 border-r border-pink-100/50 backdrop-blur-sm"
