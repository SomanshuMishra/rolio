...
const socialLinks = [
  ...
  { icon: Mail, href: "mailto:hello@rolio.ai", label: "Email" },
]
  ...
  return (
    <footer className="relative border-t border-border bg-card/30">
      ...
      <div 
        ...
        style={{
          background: "radial-gradient(ellipse at 50% 100%, oklch(0.62 0.25 290 / 0.05) 0%, transparent 50%)",
        }}
      />
        ...
        <div className="grid gap-12 lg:grid-cols-6">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="mt-4 max-w-xs text-sm text-muted-foreground leading-relaxed">
              The AI-powered career operating system. Find your dream job with 
              intelligent matching, resume optimization, and career insights.
            </p>
